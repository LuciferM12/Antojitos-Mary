...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE RESERVACIONES (ACTIVAS O INACTIVAS) "), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Cell(1);  // mover a la derecha
  ...
  $pdf->Cell(85, 10, utf8_decode("El presente listado presenta los reportes de todas las reservaciones (Activas o inactivas) al día generado"), 0, 0, '', 0);
  $pdf->Ln(5);
